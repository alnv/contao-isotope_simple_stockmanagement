...
$table = Richardhj\IsotopeSimpleStockManagement\Model\Stock::getTable();
 ...
 * References
 */
$GLOBALS['TL_LANG'][$table]['source_options'][Richardhj\IsotopeSimpleStockManagement\Model\Stock::STOCKMANAGEMENT_SOURCE_BACKEND] = 'Backend';
$GLOBALS['TL_LANG'][$table]['source_options'][Richardhj\IsotopeSimpleStockManagement\Model\Stock::STOCKMANAGEMENT_SOURCE_ORDER] = 'Bestellung';
$GLOBALS['TL_LANG'][$table]['source_options'][Richardhj\IsotopeSimpleStockManagement\Model\Stock::STOCKMANAGEMENT_SOURCE_IMPORT] = 'Import';
